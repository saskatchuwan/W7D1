...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _actions_todo_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_TODOS"]:
      return {
        todos: _objectSpread({}, action.todos)
      };
...
var configureStore = function configureStore() {
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_root_reducer__WEBPACK_IMPORTED_MODULE_1__["default"]);
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.store = store;
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Todo list"), document.getElementById('container'));
});
